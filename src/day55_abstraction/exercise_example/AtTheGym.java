...
public class AtTheGym {
    public static void main(String[] args) {
       // Exercise exercise = new Exercise();--> cannot create object/instance abstract class
        Exercise exercise = new Running(); //polymorphism  benefits of abstraction. later topic
