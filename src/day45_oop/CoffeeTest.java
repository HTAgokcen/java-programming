...
public class CoffeeTest {
    public static void main(String[] args) {
        ...
        System.out.println("coffee2 type = " + coffee2.getType()); //it will print out coffee2 type = Espresso
        ...
        Coffee coffee4 = null;
        coffee4.setType("turkish");//NullPointerException-->your pointer cant find anything
