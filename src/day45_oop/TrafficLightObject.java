...
public class TrafficLightObject {
    public static void main(String[] args) {
        ...
        //
        // we will assign/update the value of color using a method of the clasSystem.out.println("current color = " + trafficLight.color); //DIRECT access to variable. Not recommended
