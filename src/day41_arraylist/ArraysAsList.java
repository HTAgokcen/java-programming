...
public class ArraysAsList {
    public static void main(String[] args) {
        ...
        //nums.add(100); _>it is not work, cant add arraylist, unmutable
        //nums.remove(0); UnsupportedOperationException
        //nums.clear(); UnsupportedOperationException
        List<Integer> numsList = new ArrayList<>(Arrays.asList(4, 2, 4, 23, 5444, 100));
        numsList.add(33);
        numsList.add(56);
        ...
        /**
         * List String drinksWithCaffeine -> cofee, tea. monster, red bull, coke.pepsi, mdew, kambucha,celsius
         ...
         */
        List<String> drinksWithCaffeine = new ArrayList<>(Arrays.asList("cofee", "tea", "monster", "red bull", " mdew", "kambucha", "celsius"));
